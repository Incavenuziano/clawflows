...
- 🐛 **New submit-issue workflow** — Your agent can now file GitHub issues on ClawFlows when it hits a bug or has an idea. Gathers context, checks for duplicates, and submits via `gh`. The bananas are finally reporting their own bruises! 🍌
